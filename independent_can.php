...
date_default_timezone_set("asia/manila");
	...
	<br><br>
	<h2 align="center" style="margin-left: 10px; margin-top: 50px;">INDIPENDENT CANDIDATE(S)</h2><br><br>
	<table align="center" class="table table-condensed" width="100%;">
	<?php

	$sql = "select * from tbl_candidates where Can_Partylist = 'none'";
	$today = date("Y-m-d");
	...
	<a href="add_partylist.php" style="text-decoration-line: none; position: fixed; margin-left: -730px; margin-top: 30px;"><input type="button" class='btn btn-primary btn-lg' value="Back"></a>
	<br><br>
	<h2 align="center" style="margin-left: 10px; margin-top: 50px;">INDEPENDENT CANDIDATE(S)</h2><br><br>
	<table align="center" class="table table-condensed" width="100%;">
	<?php
