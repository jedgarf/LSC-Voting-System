...
<div>
<h1 align="center" style="float: left; margin-left: 10px;"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> <b>BUSINESS MANAGER</b></h1>
<a href="skip5.php" style="float: right; margin-right: 50px; margin-top: 15px;"><input align="right" type="button" class="btn btn-primary btn-lg" name="" value="Skip Business Manager"></a>
	...
	<?php
	require 'dbcon.php';
	$sql = "select * from tbl_candidates where Can_Position = 'Business Manager'";
	...
	echo "<tr>";	
		...
		echo "<td><a href = 'vote5.php?nom=$res[Can_ID]'><input type='button' class='btn btn-primary' value='Vote'></a></td>";	
		echo "</tr>";
		echo "<tr>";
