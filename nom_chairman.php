...
<form method="POST">
	<div>
<h1 align="center" style="float: left; margin-left: 10px;"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> <b>CHAIRMAN</b></h1>
<a href="skip1.php" style="float: right; margin-right: 50px; margin-top: 15px;"><input align="right" type="button" class="btn btn-primary btn-lg" name="" value="Skip Chairman"></a>
	...
	<?php
	require 'dbcon.php';
	$sql = "select * from tbl_candidates where Can_Position = 'Chairman'";
	...
	echo "<tr>";	
		...
		echo "<td><a href = 'vote1.php?nom=$res[Can_ID]'><input type='button' class='btn btn-primary' id='myButton' data-loading-text='Loading...' value='Vote'></a></td>";	
		echo "</tr>";
		echo "<tr>";
