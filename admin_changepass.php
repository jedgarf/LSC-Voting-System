...
<body class="bg-1" style="background-image: url('images/b.png');">
		<h3 align="center"><span class="glyphicon glyphicon-lock"></span> <label>CHANGE PASSWORD</label></h3>
	<br>
	<form name="form1" method="POST" autocomplete="off">
		<table align="center">
			...
			<tr>
				...
				<td align="center"><input  class="btn btn-primary" type="submit" name="update" value="Update"></td>
			</tr>
		</table>
<?php
if(isset($_POST['update'])){
	...
	$repass = $_POST['repass'];
		...
		$sql3 = "select Acc_Pword from tbl_administrator where Acc_Uname = '$user'";
	...
	if ($realpass == $cpas) {
		if ($pass == $repass) {
			...
			$repas = md5($repass);
			$sql2 = "UPDATE tbl_administrator SET Acc_Pword = '$repas', Acc_Quest = '$quest',Acc_Ans = '$ans' WHERE Acc_Uname = '$user'";
			$conn->query($sql2);
			?>

			<script type="text/javascript">
				alert("Password Has Successfully Changed!");
				window.parent.location = "Administrator_Module.php";
			</script>
